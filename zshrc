...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/Users/sadanand/.anaconda3/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/sadanand/.anaconda3/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/sadanand/.anaconda3/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
